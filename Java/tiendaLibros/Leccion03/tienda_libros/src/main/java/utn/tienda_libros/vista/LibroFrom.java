...
public class LibroFrom extends JFrame {
    ...
    public LibroFrom(LibroServicio libroServicio) {
        ...
        tablaLibros.addHierarchyListener(new HierarchyListener() {
            @Override
            public void hierarchyChanged(HierarchyEvent e) {
                // Codigo que quiera ejecutar
                System.out.println("Jerarquia cambiada en la tabla");
            }
        });
    ...
    private void agregarLibro() {
        ...
        // Leer los valoes del formulario
        if(libroTexto.getText().equals("")){
         ...
         var existencias = Double.parseDouble(existenciasTexto.getText());
